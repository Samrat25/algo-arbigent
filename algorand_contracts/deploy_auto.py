"""
Automated deployment script for Algorand Vault Smart Contract
"""
...
# User mnemonic
CREATOR_MNEMONIC = "parrot gorilla diary reject pizza since toilet alcohol limit junk popular bright curve lyrics awesome move purchase cruel before slice carry ancient cycle abandon indicate"
...
def main():
    ...
    print(f"\nBackend (.env):")
    print(f"FAUCET_MNEMONIC={CREATOR_MNEMONIC}")
    print(f"APP_ID={app_id}")
    print(f"USDC_ASSET_ID={usdc_asset_id}")
    print(f"USDT_ASSET_ID={usdt_asset_id}")
    
    print(f"\nFrontend (.env):")
    print(f"VITE_APP_ID={app_id}")
    print(f"VITE_USDC_ASSET_ID={usdc_asset_id}")
    print(f"VITE_USDT_ASSET_ID={usdt_asset_id}")
